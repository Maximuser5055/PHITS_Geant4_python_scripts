...
1- HOW TO BUILD AND RUN THE EXAMPLES
  ...
  The example codes were tested in Geant4.10.06 and its patch versions.
  ...
  2) How to run
    ...
    a) 'External'
        ...
        -f                      optional  switch to change the phantom to MRCP-AF
          ...
          ex) MRCP-AM: % ./External -m example.in -o example_AM.out
          ex) MRCP-AF: % ./External -m example.in -o example_AF.out -f 
    ...
    b) 'Internal'  
        ...
        -f                      optional  switch to change the phantom to MRCP-AF
          ...
          ex) MRCP-AM: % ./Internal -i 9500 -m example.in -o example_AM.out
          ex) MRCP-AF: % ./Internal -i 9500 -m example.in -o example_AF.out -f 
