...
// \file   MRCP_GEANT4/Internal/src/TETDetectorConstruction.cc
// \author HUREL
//
...
void TETDetectorConstruction::SetupWorldGeometry()
{
	...
	//
	G4Box* containerSolid = new G4Box("phantomBox", phantomSize.x() * 0.5 + 10.*cm,
										            phantomSize.y() * 0.5 + 10.*cm,
										            phantomSize.z() * 0.5 + 10.*cm);
